...
const Authority = () => {
  return (
    <div className="lg:w-[450px] mt-10  w-[calc(100%-30px)]  mx-auto justify-between
    px-7 py-5 bg-[#0b4d54] rounded-[20px] flex lg:flex-col gap-[15px] ">
      ...
      <div className="flex lg:flex-row flex-col items-center space-x-5 gap-[20px]  space-y-3">
        ...
        <p className="text-white font-medium text-[16px] max-sm:text-[13px] text-center">
      ...
      <div className="lg:flex hidden items-center gap-[20px] space-x-5 space-y-3 ">
        ...
        <p className="text-white font-medium max-sm:text-[13px] text-[16px]">
